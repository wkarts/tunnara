...
export const menuItems: MenuItemConfig[] = [
  ...
  { title: "Traffic Policies", route: "/politicas", permission: "config:view", feature: "accessPolicies", section: "seguranca" },
  { title: "Request Inspector", route: "/inspector", permission: "config:view", feature: "requestInspector", section: "seguranca" },
